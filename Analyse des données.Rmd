...
```
Observation du taux d'erreur pour les séquences Fs. On observe une forte diminution du score de qualité vers 200 nucléotide. La coupe se fera ici, ie que tous les nucléotides supérieur à 200 seront supprimés

```{r}
plotQualityProfile(fnRs[1:2])
```
Observation du taux d'erreur pour les séquences Rs. On observe une forte diminution du score de qualité vers 200 nucléotide. La coupe se fera ici, ie que tous les nucléotides supérieur à 200 seront supprimés
